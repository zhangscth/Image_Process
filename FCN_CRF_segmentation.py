...
image_filename = './imgs/cat.jpg'
annotation_filename = './imgs/cat_annotation.png'
...
from tf_FCN_CRF.nets import vgg
from tf_FCN_CRF.preprocessing import vgg_preprocessing
...
upsample_factor = 32
number_of_classes = 2
log_folder = './segmentation/log_folder'
...
with tf.Session() as sess:
    ...
    #
    # plt.show()
    # processed_probabilities=final_probabilities

    print("Final Loss: " + str(final_loss))

summary_string_writer.close()

# np.save("./processed_probabilities.npy",processed_probabilities)

processed_probabilities = np.load("processed_probabilities.npy")[0]
import sys

path = "./dense_crf_python/"
...
#ValueError: Bad shape for unary energy (Need (2, 168960), got (352, 960))
softmax = processed_probabilities.transpose((2, 0, 1))
from tf_FCN_CRF.densecrf_demo import densecrf_func
print(image.shape)
# plt.imshow(image)
# plt.show()
densecrf_func(image,softmax,2)
